 ...
 */
public class AngleBackwardsDownCapability implements Capability {

    private WordGenerator wordGenerator;

    public AngleBackwardsDownCapability(WordGenerator wordGenerator) {
        this.wordGenerator = wordGenerator;
    }

    public String getName() {
        return "Angled Down and Backwards";
    }

    public String getDescription() {
        return "Adds words angled down and backwards in the puzzle";
    }
