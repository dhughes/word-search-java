...
public class HorizontalBackwardsCapability implements Capability {

    private WordGenerator wordGenerator;

    public HorizontalBackwardsCapability(WordGenerator wordGenerator) {
    ...
    public String getDescription() {
        return "Adds words backwards horizontally in the puzzle";
    }
    ...
    public void addWord(Puzzle puzzle, Configuration configuration, Random random) throws NoMatchingWordsFoundException {
        ...
        int y1 = random.nextInt(configuration.getHeight());
